...
namespace Eco.Echolon.ApiClient.Client.GraphQl
{
    public interface ITextTemplatesClient
    {
        ...
        // Task<GraphQlResponse<object>> TextTemplatesStore(FormattedTextTemplateInput input);
        // Task<GraphQlResponse<object>> TextTemplatesDelete(string id);
        // Task<GraphQlResponse<object>> TextTemplatesActivate(string id);
        // Task<GraphQlResponse<object>> TextTemplatesDeactivate(string id);
    }
